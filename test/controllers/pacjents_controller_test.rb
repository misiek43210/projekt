...
class PacjentsControllerTest < ActionController::TestCase
  ...
  test "should create pacjent" do
    assert_difference('Pacjent.count') do
      post :create, pacjent: { ID_Pacjenta: @pacjent.ID_Pacjenta, data_urodzenia: @pacjent.data_urodzenia, imie: @pacjent.imie, nazwisko: @pacjent.nazwisko, pesel: @pacjent.pesel }
    end
  ...
  test "should update pacjent" do
    patch :update, id: @pacjent, pacjent: { ID_Pacjenta: @pacjent.ID_Pacjenta, data_urodzenia: @pacjent.data_urodzenia, imie: @pacjent.imie, nazwisko: @pacjent.nazwisko, pesel: @pacjent.pesel }
    assert_redirected_to pacjent_path(assigns(:pacjent))
  end
